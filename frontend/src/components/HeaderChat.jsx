...
export const HeaderChat = ({ back, name }) => {
  return (
    <>
      <div className='flex min-w-0 py-3 px-3 items-center border-b border-gray-700'>
        <div
        ...
        <img
          ...
          className='size-10 flex-none rounded-full bg-gray-800 outline -outline-offset-1 outline-white/10'
        />
